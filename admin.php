...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <h2> 
        <a href="index2.php" ><i class="bi bi-house"></i></a>
 ...
 "></i><span>Malumotlar kiritish</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="ryuklash.php">
              <i class="bi bi-circle"></i><span>Rasm kiritish</span>
            </a>
          </li>
          <li>
            <a href="vyuklash.php">
              <i class="bi bi-circle"></i><span>Video kiritish</span>
            </a>
          </li>
</ul>
      <li class="nav-item">
...
{  echo $_SESSION['xabari'];
    ...
    ?>
              ...
              <div class="news">
              <form action="Ryangilash.php">
              <?foreach($ras as $rasmlar) :?>
                
                <div class="post-item clearfix">
               
                  <a href="<?=$rasmlar['location']?>">
                  <img src="<?=$rasmlar['location']?>" name="<?=$rasmlar['location']?>" alt="">
              </a>
             

                  <h4><input type="text" class="form-control" name="<?=$rasmlar['rasm_name']?>" value="<?=$rasmlar['rasm_name']?>"> </h4>
                  <h4><textarea  class="form-control" style="height: 100px; width: 500px;"   name="<?=$rasmlar['rasm_status']?>"> <?=$rasmlar['rasm_status']?></textarea>      <!-- Vertically centered Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     Videoni formatiga e'tibor berdingizmi? <i class="bi bi-file-earmark-easel"></i><br>
                     Ushbu videoyingiz kiritayotgan malumotingizga to'g'ri keladimi? <i class="bi bi-file-earmark-play"></i><br>
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Yopish <i class="bi bi-file-earmark-x"></i></button>
                      <button type="submit" class="btn btn-primary">Videoni kiritish <i class="bi bi-folder-symlink"></i></button>
                      </form>
                      <form action="rdelete.php">
               <button type="submit" class="btn btn-secondary"><i class="bi bi-collection"></i> O'chirish</button>
               <input type="hidden" value="<?=$rasmlar['rasm_id']?>" name="ras_id">
            </form>
