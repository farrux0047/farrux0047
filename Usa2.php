...
$date= date('Y-m-d');        
          ...
          $carusel=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Janubiy Amerika'");
          if(mysqli_num_rows($carusel) > 0){
            ...
            $csqlr=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Janubiy Amerika'");
            if(mysqli_num_rows($csqlr) > 0){  
              $caruselr = mysqli_fetch_assoc($csqlr);
              }


              $rowvid=mysqli_query($conn,"SELECT * FROM video WHERE sana='$date' and sahifa='Janubiy Amerika'");
        ...
        $sqlr = mysqli_query($conn, "SELECT * FROM rasm WHERE sahifa ='Janubiy Amerika'");
        ...
        $sqql = mysqli_query($conn, "SELECT * FROM video WHERE sahifa ='Janubiy Amerika'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Dunyo mamlakatlari</li>
          <li class="breadcrumb-item active">Janubiy Amerika</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
