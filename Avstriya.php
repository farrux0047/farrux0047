...
$date= date('Y-m-d');        
          ...
          $carusel=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Avstriya'");
          if(mysqli_num_rows($carusel) > 0){
            ...
            $csqlr=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Avstriya'");
            if(mysqli_num_rows($csqlr) > 0){  
              $caruselr = mysqli_fetch_assoc($csqlr);
              }


              $rowvid=mysqli_query($conn,"SELECT * FROM video WHERE sana='$date' and sahifa='Avstriya'");
        ...
        $sqlr = mysqli_query($conn, "SELECT * FROM rasm WHERE sahifa ='Avstriya'");
        ...
        $sqql = mysqli_query($conn, "SELECT * FROM video WHERE sahifa ='Avstriya'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Avstriya</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
