...
$date= date('Y-m-d');        
          ...
          $carusel=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Yevropa'");
          if(mysqli_num_rows($carusel) > 0){
            ...
            $csqlr=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Yevropa'");
            if(mysqli_num_rows($csqlr) > 0){  
              $caruselr = mysqli_fetch_assoc($csqlr);
              }


              $rowvid=mysqli_query($conn,"SELECT * FROM video WHERE sana='$date' and sahifa='Yevropa'");
        ...
        $sqlr = mysqli_query($conn, "SELECT * FROM rasm WHERE sahifa ='Yevropa'");
        ...
        $sqql = mysqli_query($conn, "SELECT * FROM video WHERE sahifa ='Yevropa'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Dunyoni mamlakatlari</li>
          <li class="breadcrumb-item active">Yevropa</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
