...
$date= date('Y-m-d');        
          ...
          $carusel=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Dunyo tabiiy geografiyasi'");
          if(mysqli_num_rows($carusel) > 0){
            ...
            $csqlr=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Dunyo tabiiy geografiyasi'");
            if(mysqli_num_rows($csqlr) > 0){  
              $caruselr = mysqli_fetch_assoc($csqlr);
              }


              $rowvid=mysqli_query($conn,"SELECT * FROM video WHERE sana='$date' and sahifa='Dunyo tabiiy geografiyasi'");
        ...
        $sqlr = mysqli_query($conn, "SELECT * FROM rasm WHERE sahifa ='Dunyo tabiiy geografiyasi'");
        ...
        $sqql = mysqli_query($conn, "SELECT * FROM video WHERE sahifa ='Dunyo tabiiy geografiyasi'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Dunyoning tabiiy geografiyasi</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
