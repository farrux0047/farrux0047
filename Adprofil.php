...
<head>
  ...
  <title>Geograflar Faoiliyati - Admin - profile</title>
  <!-- loader-->
 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      <li class="sidebar-header"><?=$user['Ism']." ".$user['fam']." "?></li>
      <li>
        <a href="index.html">
      ...
      <li>
        <a href="contactad.php">
          <i class="zmdi zmdi-invert-colors"></i> <span>Foydalanuvchilar xabari</span>
        </a>
      </li>

      <li>
        <a href="forms.html">
          <i class="zmdi zmdi-format-list-bulleted"></i> <span>Malumotlar</span>
        </a>
      </li>

      <li>
        <a href="tables.html">
          <i class="zmdi zmdi-grid"></i> <span>t</span>
        </a>
      </li>
        ...
        <div class="col-lg-8">
           <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                ...
                <li class="nav-item">
                    <a href="" data-target="#messages" data-toggle="pill" class="nav-link"><i class="icon-envelope-open"></i> <span class="hidden-xs">Messages</span></a>
                </li>
                <li class="nav-item">
	...
	<footer class="footer">
      <div class="container">
        <div class="text-center">
          Copyright © 2022 Ismoilov Farruxbek
        </div>
      </div>
    </footer>
	<!--End footer-->
