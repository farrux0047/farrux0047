...
<div class="clearfix"></div>
  ...
  <!-- Full Calendar -->
  <script src='admin/assets/plugins/fullcalendar/js/moment.min.js'></script>
  <script src='admin/assets/plugins/fullcalendar/js/fullcalendar.min.js'></script>
  <script src="admin/assets/plugins/fullcalendar/js/fullcalendar-custom-script.js"></script>
