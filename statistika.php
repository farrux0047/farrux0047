...
<?php
$statistika = mysqli_query($conn, "SELECT * FROM status WHERE sahifa='Qiziqarlik statistikalar'");
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tinch okeani</h5>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Eng chuqur joyi</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
