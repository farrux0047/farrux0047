...
$date= date('Y-m-d');        
          ...
          $carusel=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Shimoliy Amerika'");
          if(mysqli_num_rows($carusel) > 0){
            ...
            $csqlr=mysqli_query($conn,"SELECT * FROM rasm WHERE date='$date' and sahifa='Shimoliy Amerika'");
            if(mysqli_num_rows($csqlr) > 0){  
              $caruselr = mysqli_fetch_assoc($csqlr);
              }


              $rowvid=mysqli_query($conn,"SELECT * FROM video WHERE sana='$date' and sahifa='Shimoliy Amerika'");
        ...
        $sqlr = mysqli_query($conn, "SELECT * FROM rasm WHERE sahifa ='Shimoliy Amerika'");
        ...
        $sqql = mysqli_query($conn, "SELECT * FROM video WHERE sahifa ='Shimoliy Amerika'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Shimoliy Amerika</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
